...
exports.version = function(){
    if(!fs.existsSync(path.join(__dirname, "version", cmd.version))){
...
exports.module2engine = function(){
    ...
    for(var p in module){
        module[p].forEach(function(item){
            ...
            var dir = path.join(cmd.dir, item);
...
exports.generate = function(){
    var dist = fs.readdirSync(path.join(cmd.dir, cmd.name, "dist"));
    var src = fs.readdirSync(path.join(cmd.dir, cmd.name, "src"));
